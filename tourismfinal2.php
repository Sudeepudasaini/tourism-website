...
<body>
  <div class="navbar">
    ...
    <div class="navbar-links">
      ...
      <a href="login_form1.php">Login/Signin</a>
    ...
    <div class="Explore-Destination">
      ...
      <div class="explore-cards">
        ...
        <div class="description">
          ...
          <a href="pashupati-des.php"><span id="Patan-durbar-readmore"><button>Read
                More..</button></span></a>
        </div>
      </div>
      <!-- next card -->
...
<div class="about-image">
  <img src="Images/treking.jpg" alt="treking-about">
</div>
<div class="about-content">
  <h3>About us</h3>
  <p> Sudeep is user interface designer and Silas is backend designer.We have build many website.And, now we make this website to make easy  to tourist to choose best place.</p>
